...
Pod::Spec.new do |s|
  ...
  s.source_files  = "Frameworks/Decodable/Decodable/**/*.swift"
  ...
  s.resources = ['Frameworks/Decodable/Decodable/**/*.storyboard', 'Frameworks/Decodable/Decodable/**/*.xib', 'Frameworks/Decodable/Decodable/**/*.xcassets', 'Frameworks/Decodable/Decodable/**/*.lproj']
  # s.resource  = "icon.png"
