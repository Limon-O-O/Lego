...
Pod::Spec.new do |s|
  ...
  s.source_files  = "LegoProvider/**/*.swift"
  ...
  s.resources = ['LegoProvider/**/*.storyboard', 'LegoProvider/**/*.xib', 'LegoProvider/**/*.xcassets', 'LegoProvider/**/*.lproj']
  # s.resource  = "icon.png"
