...
Pod::Spec.new do |s|
  ...
  s.author             = { "__Author__" => '${USER_EMAIL}' }
  ...
  s.source_files  = "__ProjectName__/**/*.swift"
  ...
  s.resources = ['__ProjectName__/**/*.storyboard', '__ProjectName__/**/*.xib', '__ProjectName__/**/*.xcassets', '__ProjectName__/**/*.lproj']
  # s.resource  = "icon.png"
