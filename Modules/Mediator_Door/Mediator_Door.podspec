...
Pod::Spec.new do |s|
  ...
  s.name         = "Mediator_Door"
  s.version      = "0.0.1"
  s.summary      = "Mediator_Door."
  ...
  s.source_files  = "Mediator_Door/**/*.swift"
  ...
  s.resources = ['Mediator_Door/**/*.storyboard', 'Mediator_Door/**/*.xib', 'Mediator_Door/**/*.xcassets', 'Mediator_Door/**/*.lproj']
  # s.resource  = "icon.png"
