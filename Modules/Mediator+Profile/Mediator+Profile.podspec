...
Pod::Spec.new do |s|
  ...
  s.name         = "Mediator+Profile"
  s.version      = "1.0.0"
  s.summary      = "Mediator+Profile."
  ...
  s.source_files  = "Mediator+Profile/Mediator+Profile/**/*.swift"
  ...
  s.resources = ['Mediator+Profile/Mediator+Profile/**/*.storyboard', 'Mediator+Profile/Mediator+Profile/**/*.xib', 'Mediator+Profile/Mediator+Profile/**/*.xcassets', 'Mediator+Profile/Mediator+Profile/**/*.lproj']
  # s.resource  = "icon.png"
