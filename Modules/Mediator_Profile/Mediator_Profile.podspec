...
Pod::Spec.new do |s|
  ...
  s.name         = "Mediator_Profile"
  s.version      = "0.0.1"
  s.summary      = "Mediator_Profile."
  ...
  s.source_files  = "Mediator_Profile/**/*.swift"
  ...
  s.resources = ['Mediator_Profile/**/*.storyboard', 'Mediator_Profile/**/*.xib', 'Mediator_Profile/**/*.xcassets', 'Mediator_Profile/**/*.lproj']
  # s.resource  = "icon.png"
