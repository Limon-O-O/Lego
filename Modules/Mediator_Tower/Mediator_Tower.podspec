...
Pod::Spec.new do |s|
  ...
  s.name         = "Mediator_Tower"
  s.version      = "0.0.1"
  s.summary      = "Mediator_Tower."
  ...
  s.source_files  = "Mediator_Tower/**/*.swift"
  ...
  s.resources = ['Mediator_Tower/**/*.storyboard', 'Mediator_Tower/**/*.xib', 'Mediator_Tower/**/*.xcassets', 'Mediator_Tower/**/*.lproj']
  # s.resource  = "icon.png"
